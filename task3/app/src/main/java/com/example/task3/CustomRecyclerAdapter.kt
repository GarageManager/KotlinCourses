...
class CustomRecyclerAdapter(private val values: List<HabitInfo>, private val rv: RecyclerView, private val activity: MainActivity) :
    ...
    override fun onClick(view: View?) {
        ...
        activity.handleRvClick(item, itemPosition)
    }
}